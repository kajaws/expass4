...
public class JpaTest {
    ...
    public void deletePerson() {
        ...
        // Create a new Person entity to ensure it exists
        Person newPerson = new Person();
        newPerson.setFirstName("Jim_1");
        newPerson.setLastName("Knopf_!");
        ...
        // Now we expect a NoResultException when querying for the deleted person
